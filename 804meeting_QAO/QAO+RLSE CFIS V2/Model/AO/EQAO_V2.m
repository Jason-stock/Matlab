function [gBest, thenParm, yAll] = EQAO_V2(tIter, H_train, Y_train, particleNum, baseVarFuzzyN)
% EQAO_V2 - Enhanced Quantum Aquila Optimizer Version 2
% 適用於統合FIS系統的增強型量子老鷹優化演算法
%
% 與V1版本的主要差異：
% - 使用unifiedFIS替代cFIS
% - 優化的記憶體管理
...
fprintf('=== EQAO V2 (Enhanced Quantum Aquila Optimizer V2) ===\n');
...
fprintf('=== EQAO V2 優化完成! 最終RMSE: %.6f ===\n', gBestVal);
end

%% =================== 量子擾動相關函數 ===================
% (與V1版本相同的量子函數 - 為保持完整性重複定義)
